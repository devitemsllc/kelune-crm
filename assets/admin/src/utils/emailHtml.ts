...
// screen. Format MUST match EmailService (PHP): `<!--cm:global-footer:COLOR-->`.
...
export const GLOBAL_FOOTER_MARKER_RE = /<!--cm:global-footer:(.*?)-->/;
...
// (PHP): `<!--cm:email-doc-->`.
export const EMAIL_DOC_MARKER = '<!--cm:email-doc-->';
export const EMAIL_DOC_MARKER_RE = /<!--cm:email-doc-->/;
...
// outer margin. Individual block bodies no longer set these themselves.
