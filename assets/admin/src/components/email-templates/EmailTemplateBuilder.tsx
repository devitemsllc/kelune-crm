...
const EmailTemplateBuilder = ({
  ...
  // Where the Elementor-style insertion line renders during a palette drag; the
  // new block is only committed to the tree on drop.
  ...
  const sidebarInner = selectedBlock ? (
    <>
      ...
      >
        ...
        <span>
          {sprintf(
            // translators: %s is the block type name (e.g. Text, Image).
            ...
            >
              ...
              >
                {previewMode ? (
                  ...
                  >
                    <iframe
                      srcDoc={`${PREVIEW_NO_LINK_STYLE}${resolveFooterForPreview(previewHtml)}`}
                      style={{
                        width: '100%',
                        height: '100%',
                        border: 'none',
