      ...
      <Card loading={loading}>
        <Form form={form} layout="vertical" onFinish={save}>
          ...
          <Text type="secondary" style={{ display: 'block', marginBottom: 24 }}>
            {__(
              'Your business name, postal address and an unsubscribe link are required by anti-spam law in most countries — without them your emails are likely to be treated as spam.',
              'kelune-crm'
            )}
          </Text>
