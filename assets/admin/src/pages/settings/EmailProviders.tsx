...
const EmailProviders = () => {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      message.success(
        sprintf(
          // translators: %d is the number of deleted email providers.
          _n(
  ...
  return (
    <div className="kelune-crm-cc-email-providers-container">
      <ListPageHeader
        ...
        primaryAction={{
          label: __('Add Provider', 'kelune-crm'),
          onClick: openCreate,
        }}
      ...
      <Drawer
        title={
          editing
            ...
            : __('Add Email Provider', 'kelune-crm')
        }
        width={640}
        open={drawerOpen}
          ...
          <Form.Item style={{ marginBottom: 0 }}>
            <Space>
              <Button type="primary" htmlType="submit" loading={saving}>
                {editing
                  ? __('Update Provider', 'kelune-crm')
                  : __('Create Provider', 'kelune-crm')}
              </Button>
            ...
            <Descriptions bordered column={1}>
              ...
              {details.stats && (
                <>
                  ...
                  >
                    {sprintf(
                      // translators: %s is the maximum send rate per second.
                      __('%s/sec', 'kelune-crm'),
