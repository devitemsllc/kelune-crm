...
// Sortable fields for Segments, mirroring the backend's whitelisted orderby
// columns (id, name, match_type, contact_count, last_calculated, created_at,
// updated_at). `id` is the implicit default (newest first) and is intentionally
// not offered here.
export const SORT_OPTIONS: SortOption[] = [
  { value: 'name', label: __('Segment name', 'kelune-crm') },
...
// Default: `id` DESC (newest segments first). `id` is not a user-selectable
