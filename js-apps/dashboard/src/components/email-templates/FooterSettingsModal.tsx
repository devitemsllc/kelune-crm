...
// template settings so the canvas reflects edits live. "Save" keeps the edits;
// "Cancel" — and dismissing the drawer any other way — reverts to the snapshot
// taken when it opened. The custom-footer editor is the same RichTextEditor the
// global email settings use, so both author footer HTML identically.
